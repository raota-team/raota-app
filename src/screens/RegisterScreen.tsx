...
import { ChevronLeft, ChevronRight, Check, X, RotateCw, Camera, MapPin, Sparkles, BookOpen, Compass } from 'lucide-react'
      ...
      <div className="h-full flex flex-col justify-between bg-[#FFFFFF] text-[#25282B] overflow-y-auto no-scrollbar p-5 anim-fade-in">
        <div className="pt-2 text-center space-y-3">
          ...
          <div className="flex rounded-[8px] bg-[#F2F2F2] p-1 gap-1 border border-[#E2E2E2]">
            ...
            >
              <RamenIcon className={`w-3.5 h-3.5 ${onboardingTab === 'log' ? 'text-[#E60000]' : 'text-[#7E7E7E]'}`} />
              <span>라멘로그</span>
            </button>
